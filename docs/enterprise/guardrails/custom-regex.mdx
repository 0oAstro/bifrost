...
Create the Custom Regex provider configuration directly with the management API. The provider type is the path segment (`regex`); the API assigns the configuration ID after creation.
